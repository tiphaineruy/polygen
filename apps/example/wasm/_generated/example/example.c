...
static u32 w2c_example_fib_0(w2c_example*, u32);

FUNC_TYPE_T(w2c_example_t0) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";

static void init_memories(w2c_example* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 0, 65536, 0);
}

/* export: 'fib' */
u32 w2c_example_fib(w2c_example* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  u32 ret = w2c_example_fib_0(instance, var_p0);
...
void wasm2c_example_instantiate(w2c_example* instance) {
...
void wasm2c_example_free(w2c_example* instance) {
...
u32 w2c_example_fib_0(w2c_example* instance, u32 var_p0) {
